...
/// <summary>
/// A resource that represents a MongoDB Atlas container.
/// </summary>
/// <param name="name">The name of the resource.</param>
public class MongoDBAtlasServerResource(string name) : ContainerResource(name), IResourceWithConnectionString
{
    ...
    public MongoDBAtlasServerResource(string name, ParameterResource? userNameParameter, ParameterResource? passwordParameter) : this(name)
    {
    ...
    internal ReferenceExpression BuildConnectionString(string? databaseName = null)
    {
        ...
        if (PasswordParameter is not null)
        {
            builder.Append($"?authSource={DefaultAuthenticationDatabase}&authMechanism={DefaultAuthenticationMechanism}&directConnection=true");
        }
