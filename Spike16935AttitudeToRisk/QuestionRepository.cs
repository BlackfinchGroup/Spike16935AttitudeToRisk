...
internal class QuestionSetRepository
{
    ...
    public QuestionSetRepository()
    {
        ...
        {
            QuestionOneSet, QuestionTwoSet, QuestionThreeSet, QuestionFourSet, QuestionFiveSet
        };
    }
    ...
    private static QuestionSet QuestionFiveSet =>
        new QuestionSet()
        {
            ...
            Questions = new List<Question>()
            {
                new Question() { Id = Guid.NewGuid(), Text = "I’ve never invested before", Weighting = 1 },
                new Question() { Id = Guid.NewGuid(), Text = "I’ve tried a savings account or cash ISA", Weighting = 2 },
                new Question() { Id = Guid.NewGuid(), Text = "I’ve done some investing, but only with low risk", Weighting = 3 },
                new Question() { Id = Guid.NewGuid(), Text = "I’ve invested in funds or shares and understand they go up and down", Weighting = 4 },
                new Question() { Id = Guid.NewGuid(), Text = "I regularly invest and understand risk levels well", Weighting = 5 },
            }
        };
